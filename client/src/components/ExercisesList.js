        ...
        {this.state.exercises.map((exerciseName, index) => {
          return (
            ...
            >
              ...
              <svg id="myShape" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                  <defs>
                  ...
                  <circle cx="125" cy="130" r="110" fill="url(#grad1)" stroke="rgb(44, 44, 44)" stroke-width="12"/>
                  <circle cx="125" cy="130" r="24" stroke="url(#grad1)" stroke-width="10" fill="rgb(44, 44, 44)" />
                  <circle cx="125" cy="130" r="14" fill="#29323c" />
                  <text id="myText" fill="white" font-family="Helvetica" font-size="18px" text-anchor="middle" font-weight="bold">
                    <textPath  startOffset="50%" xlinkHref="#path1" >
                      <tspan>{exerciseName}</tspan>
                    </textPath>
                  </text>
                  <text x="36" y="136" fill="white" font-weight="bold">20.5</text>
                  <text x="48" y="156" fill="white" font-weight="bold">KG</text>
                  <text x="170" y="136" fill="white" font-weight="bold">{index > 1 ? index * 10 + 5 : index * 5 + 5}</text>
                  <text x="171" y="156" fill="white" font-weight="bold">LB</text>
                </svg>
            </Link>
          );
        })}
